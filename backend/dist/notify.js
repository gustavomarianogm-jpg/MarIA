...
exports.notifyCuradoria = notifyCuradoria;
exports.notifyClientApproval = notifyClientApproval;
exports.notifyClientRejection = notifyClientRejection;
exports.notifyClientMatch = notifyClientMatch;
exports.notifyJournalistNewMatch = notifyJournalistNewMatch;
 ...
 */
async function notifyCuradoria({ clientName, title, content, storyId }) {
...
async function notifyClientApproval(clientEmail, clientName, title) {
    const htmlEmail = `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; color: #333;">
...
async function notifyClientRejection(clientEmail, clientName, title, feedback) {
    const htmlEmail = `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; color: #333;">
...
async function notifyClientMatch(clientEmail, clientName, title, topMatches) {
    const matchesHtml = topMatches.map(m => `<li style="margin-bottom: 10px;"><strong>${m.name}</strong> ${m.outlet ? `(${m.outlet})` : ''} - Compatibilidade: <span style="color: #E91E8C; font-weight: bold;">${m.score}%</span></li>`).join('');
    const htmlEmail = `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; color: #333;">
...
async function notifyJournalistNewMatch(journalistEmail, journalistName, title, storyUrl) {
    const htmlEmail = `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; color: #333;">
