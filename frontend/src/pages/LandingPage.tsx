...
<nav className="sticky top-0 z-50 bg-paper/90 backdrop-blur-md border-b border-ink/15">
  <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
    ...
    <div className="flex items-center gap-3">
      ...
      <a onClick={(e) => { e.preventDefault(); onNavigate(''); }} href="#" className="btn-primary text-sm py-2.5 px-5" style={{"boxShadow":"3px 3px 0 #E91E8C"}} onClick={(e) => { e.preventDefault(); onNavigate('chat'); }}>Testar Grátis →
      </a>
    </div>
  </div>
</nav>
  ...
  <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-[1.15fr_1fr] gap-16 items-center relative">
    ...
    <div className="space-y-8">
      ...
      <div className="flex flex-col sm:flex-row gap-4 rise rise-4" id="cta-hero">
        <a href="#" className="btn-primary" onClick={(e) => { e.preventDefault(); onNavigate('chat'); }}>Criar minha 1ª pauta grátis
  ...
  <div className="max-w-5xl mx-auto px-6">
    ...
    <div className="grid md:grid-cols-[1fr_1.15fr] gap-6">
      ...
      <div className="card-news rounded-2xl p-8 text-ink">
        ...
        <a href="#" className="btn-ghost w-full justify-center" onClick={(e) => { e.preventDefault(); onNavigate('login'); }}>Começar com Acesso</a>
      </div>
      ...
      <div className="card-news rounded-2xl p-8 text-ink relative" style={{"background":"#F5B700","boxShadow":"8px 8px 0 #E91E8C"}}>
        ...
        <a href="#" className="btn-primary w-full justify-center" onClick={(e) => { e.preventDefault(); onNavigate('login'); }}>Quero o Resultado →</a>
      </div>
    </div>
...
<section className="py-24 md:py-32 bg-rose text-paper relative overflow-hidden grain">
  ...
  <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
    ...
    <div className="flex flex-col sm:flex-row gap-4 justify-center mt-12">
      <a href="#" className="btn-primary" style={{"background":"#FAF6F0","color":"#0F0A1A","boxShadow":"5px 5px 0 #0F0A1A"}} onClick={(e) => { e.preventDefault(); onNavigate('chat'); }}>Criar minha pauta grátis
        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><path d="M5 12h14M13 5l7 7-7 7"/></svg>
      </a>
  ...
  <div className="max-w-7xl mx-auto px-6">
    ...
    <div className="grid md:grid-cols-4 gap-12 mb-12">
      ...
      <div>
        ...
        <ul className="space-y-2 text-sm">
          <li><a onClick={(e) => e.preventDefault()} href="#" className="hover:text-rose">Cadastrar-se grátis</a></li>
      ...
      <div>
        ...
        <ul className="space-y-2 text-sm">
          <li><a onClick={(e) => e.preventDefault()} href="#" className="hover:text-rose">Sobre nós</a></li>
          <li><a onClick={(e) => e.preventDefault()} href="#" className="hover:text-rose">Blog (A Boa Notícia)</a></li>
